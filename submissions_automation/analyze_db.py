...
import annotations_spreadsheet
from config import *

# Which copy of the spreadsheet do you want to load
spreadsheet_path = 'C:/Users/david/git/microbe-database/submissions_automation/annotations_master 3-14-17.xlsx'
ws = annotations_spreadsheet.AnnotationsSpreadsheet(spreadsheet_path)

column = keys_to_cols['optimal_pH']
